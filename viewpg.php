...
<script>
    ...
    padding: 20px;
    text-align: left;
    height: 150px; /* Increase row height */
/* }

td img {
    max-width: 100%;
    max-height: 100%; /* Allow the image to adjust within the cell */
/* }  */
    ...
    <h2>Pg</h2>
        <table>
            ...
            $sql = "SELECT pg_name,pg_location,pg_image FROM pg";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><img src='images/" . $row["pg_image"] . "' alt='" . $row["pg_name"] . "' style='width: 100px; height: auto;'></td>";
                    // echo "<td>" . $row["phno"] . "</td>";
                    // echo "<td>
